...
> **FarmGrid** (optional). Still removed on 1.0: **GlassPieces** (throws a TypeLoadException on
...
Client set (Valheim 1.0, current): **ModSentry, Drop That, Jotunn, BetterCarts** (required) +
**FarmGrid** (optional). Removed until they ship a 1.0 build: ~~GlassPieces, Huginn Map~~.
