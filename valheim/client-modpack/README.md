...
> OneMapToRuleThemAll**; plus **FarmGrid** and **FirstPersonMode** (optional). Still removed on 1.0: **GlassPieces** (throws a TypeLoadException on
...
OneMapToRuleThemAll** (required) + **FarmGrid**, **FirstPersonMode** (optional). Removed until they ship a 1.0 build:
