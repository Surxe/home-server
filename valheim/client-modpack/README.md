...
> OneMapToRuleThemAll**; plus **FarmGrid**, **FirstPersonMode**, and **FavoriteItems** (optional). Still removed on 1.0: **GlassPieces** (throws a TypeLoadException on
...
OneMapToRuleThemAll** (required) + **FarmGrid**, **FirstPersonMode**, **FavoriteItems** (optional). Removed until they ship a 1.0 build:
