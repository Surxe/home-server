#!/usr/bin/env bash
# notify-mod-updates.sh — run the Valheim mod-update check and email eethansur@gmail.com
# when the set of update candidates CHANGES (so it never re-nags about the same update).
